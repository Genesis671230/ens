    ...
    <div className="h-screen   text-black">
      ...
      <div className="md:flex relative  bg-center bg-cover md:bg-transparent  justify-start   flex  md:min-h-[86vh]  items-center w-full px-4  md:px-0 ">
        <div className="select-none p-10      font-[Roboto] flex-1 flex flex-col tracking-normal text-[32px]   md:text-[4rem] md:leading-[80px] md:w-[35%] text-left ">
          ...
          >
            <span className="text-[#E6F4F1] text-[22px] font-SansPro leading-8 block">
              ...
              <div class="mb-12 lg:mb-0">
                ...
                >
                  ...
                  <p class="text-gray-500 mb-12">
                    Emirates National School (ENS) is an exceptional educational
                    institution that offers a diverse curriculum, experienced
                    staff, extracurricular activities, all across 6 campuses in
                    UAE.
                  </p>

                  <div class="grid md:grid-cols-4 gap-x-6">
                    <div class="mb-12 md:mb-0">
                      <h2 class="text-3xl font-bold font-Montserrat text-dark mb-4">
                        15442
                      </h2>
                    ...
                    <div class="mb-12 md:mb-0">
                      <h2 class="text-3xl font-bold text-dark font-Montserrat mb-4">
                        3515
                      </h2>
                      <h5 class="text-lg font-medium text-gray-500 mb-0">
                        Graduates
                    ...
                    <div class="">
                      <h2 class="text-3xl  font-Montserrat font-bold text-dark mb-4">
                        6
                      </h2>
                      <h5 class="text-lg font-medium text-gray-500 mb-0">
                        Campuses
          ...
          <div class="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
            ...
            >
              ...
              <p class="text-3xl md:text-4xl leading-normal md:leading-relaxed mb-2">
                Admission Process of ENS
              </p>
              <p class="text-sm md:text-base text-gray-50 mb-4">
                Here’s your guide to the addmission process 2023. Go through all
                the steps to know the exact process of the addmission.
              </p>
              <a
                href="#"
                ...
                <div class="relative wrap overflow-hidden p-10 h-full">
                  ...
                  <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                    ...
                    >
                      ...
                      <p class="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                        choose your favourite ENS campus and register in that
                        campus by filling the admission form corresponding to
                        that campus :)
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div class="order-1  w-5/12 px-1 py-4 text-left">
                      ...
                      <p class="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                        Pass in the assessment test conducted by ENS. The Roll
                        number for your registered campus will be sent to you
                        via email. Use those docs to appear in test and show
                        your talent.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div class="order-1 w-5/12 px-1 py-4 text-right">
                      ...
                      <p class="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                        ...
                        panel on 10th March, 2023 and the resukts will be
                  ...
                  >
                    ...
                    <div class="order-1  w-5/12 px-1 py-4">
                      ...
                      <p class="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                        The candidate passed assessment will be contacted by our
                        team for their addresses and the relevent campus will
                        reserved seat for candidate.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <a href="">
            <div class="flex w-full">
              <div class="relative flex flex-col items-start m-1 transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:w-80 md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
                <img
                  class="object-contain object-center w-full rounded-t-xl lg:h-48 md:h-36"
                  src={LaptopIcon}
                  alt="blog"
                />
                <div class="px-6 py-8">
                  ...
                  <p class="mt-4 text-base font-normal text-gray-500 leading-relax">
                    Enroll now in the top schools of UAE and get access to
                    world-class education and facilities. Join the diverse
                    community of ambitious students.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="flex w-full">
              <div class="relative flex flex-col items-start m-1 transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:w-80 md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
                ...
                <div class="px-6 py-8">
                  ...
                  <p class="mt-4 text-base font-normal text-gray-500 leading-relax">
                    Easily make online payments for your Emirates school
                    enrollment. Secure and convenient, our online payment system
                    ensures a smooth process for you.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="flex w-full">
              <div class="relative flex flex-col items-start m-1 transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:w-80 md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
                ...
                <div class="px-6 py-8">
                  ...
                  <p class="mt-4 text-base font-normal text-gray-500 leading-relax">
                    Get online support for your Emirates school enrollment. Our
                    dedicated team is available to assist you with any questions
      ...
      <div className="bg-gray-50 py-24  gap-10 flex flex-col  items-center px-16 ">
        <div onMouseEnter={textEnter} onMouseLeave={textLeave} className="">
          <div className="md:text-[4rem] text-center   text-sm px-32 mb-10 font-[Roboto] ">
            <span className="">Our Campuses</span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 lg:grid-cols-2">
            <div>
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                <a
                  href="#"
                  className="font-semibold font-Lato text-gray-800 hover:underline dark:text-white md:text-xl"
                >
                  Centers of Technical & Vocational Student Training
                </a>

                <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                  ENS launched the Centers of Excellence for Technical &
                  Vocational Student Training
                </p>

                <p className="mt-3 text-sm text-white w-fit md:px-6 md:py-3 bg-[#1c6d6c]">
                  Read more
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                ...
                <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                  ENS is pleased to offer healthcare sector frontline employees
                  a token of thanks and appreciation for their efforts.
                </p>
            ...
            <div>
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                ...
                >
                  ENS organized the Virtual Graduation Ceremony
                </a>

                <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                Under the patronage of Sheikh Mansour bin Zayed Al Nahyan, the Emirates National Schools organized a virtual graduation ceremony.
                </p>
            ...
            <div>
              ...
              <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                ...
                <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                Students of ENS exhibited more than 30 innovative student projects in technology and science.
                </p>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              ...
              <div className="flex mt-3 -mx-2">
                <a
                  href="#"
                  className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-[#1C6D6C] dark:hover:text-blue-400"
                  aria-label="Reddit"
                >
                  <svg
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              ...
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                Mrs. Iram Shaikah Jilani
              </h1>

              <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">
                Head of VS & IB Curriculum
              </p>
            ...
            <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              ...
              <h1 className="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">
                Eng. Mohammed Almaeeni
              </h1>

              <p className="mt-2 text-gray-500 capitalize dark:text-gray-300">
                Deputy D.G of Administration & Finance
              </p>
